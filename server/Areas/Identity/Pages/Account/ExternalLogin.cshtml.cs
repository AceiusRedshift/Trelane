...
namespace Trelane.Server.Areas.Identity.Pages.Account
{
    [AllowAnonymous]
    public class ExternalLoginModel : PageModel
    {
        ...
        private readonly IUserStore<ServerUser> _userStore;
        private readonly IUserEmailStore<ServerUser> _emailStore;
        ...
        public ExternalLoginModel(
            ...
            IUserStore<ServerUser> userStore,
        ...
        private ServerUser CreateUser()
        {
            ...
            catch
            {
                throw new InvalidOperationException($"Can't create an instance of '{nameof(ServerUser)}'. " +
                    $"Ensure that '{nameof(ServerUser)}' is not an abstract class and has a parameterless constructor, or alternatively " +
        ...
        private IUserEmailStore<ServerUser> GetEmailStore()
        {
            ...
            return (IUserEmailStore<ServerUser>)_userStore;
        }
    }
}
